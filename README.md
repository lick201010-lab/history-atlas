...
| F4 内容与来源 | pilot 准备中 | 文明、边界、事件建立来源体系 | 先做唐、罗马、阿拉伯哈里发、莫卧儿、玛雅 5 个样板来源闭环 | UI 可展示来源，关键数据有可追溯说明 |
...
2. 启动 F4 pilot：`tang`、`roman-republic-empire`、`islamic-caliphates`、`mughal`、`maya` 的来源与引用闭环。
