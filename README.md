...
一个深色 HUD 风格的 3D 历史沙盘网站，把 43 个文明、102 个历史边界阶段、30 处奇观建筑和公元前 2000 年到公元 2025 年的时间轴放在同一张可交互地形地图上。
...
| F2 边界精修 | 进行中 | 43 个文明全部升级为至少 3 阶段 rough-refined 边界 | 启动 Batch 03：夏、商、周、秦、隋 | 每批 `validate:data`、`check`、浏览器截图 QA 通过；全阶段达到 43 文明、至少 129 feature |
...
1. 提交 F2 Batch 02：希腊诸城邦、亚述、巴比伦、查理曼帝国、神圣罗马帝国。
2. 启动 F2 Batch 03：`xia`、`shang`、`zhou`、`qin`、`sui`。
3. 对 Batch 03 继续执行：数据生成、`validate:data`、`check`、浏览器截图 QA、Codex 审查、单独提交。
